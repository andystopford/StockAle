...
class ColourSettings(QtWidgets.QGroupBox):
    def __init__(self, parent=None):
        ...
        box.addWidget(QtWidgets.QLabel('Weekdays'), 0, 1)

        box.addWidget(self.weekend_swatch, 1, 0)
        box.addWidget(QtWidgets.QLabel('Weekends'), 1, 1)

        box.addWidget(self.brewday_swatch, 2, 0)
        box.addWidget(QtWidgets.QLabel('Brew Day'), 2, 1)

        box.addWidget(self.search_swatch, 3, 0)
        box.addWidget(QtWidgets.QLabel('Search Result'), 3, 1)
    ...
    def set_weekday(self):
        ...
        colour = QtWidgets.QColorDialog.getColor(self.weekday_col)
    ...
    def set_weekend(self):
        """Use QColorDialog to set background colour"""
        colour = QtWidgets.QColorDialog.getColor(self.weekend_col)
        ss = "background-color:rgb" + str(colour.getRgb())
    ...
    def set_brew(self):
        """Use QColorDialog to set background colour"""
        colour = QtWidgets.QColorDialog.getColor(self.brewday_col)
        ss = "background-color:rgb" + str(colour.getRgb())
    ...
    def set_search(self):
        """Use QColorDialog to set background colour"""
        colour = QtWidgets.QColorDialog.getColor(self.searchday_col)
        ss = "background-color:rgb" + str(colour.getRgb())
